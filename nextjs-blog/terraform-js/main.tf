...
# S3 Bucket
resource "aws_s3_bucklet" "nextjs_bucket" {
    bucket = "nextjs-portfolio-bucket-aa"
}

# Ownership Control
resource "aws_s3_bucket_ownership_controls" "nextjs_bucket_ownership_controls" {
  bucket = aws_s3_bucklet.nextjs_bucket.id
...
# Block Access
resource "aws_s3_bucket_public_access_block" "nextjs_bucket_public_block" {
...
resource "aws_s3_bucket_acl" "nextjs_bucket_acl" {
    depends_on = [ 
        ...
        aws_s3_bucket_aws_s3_bucket_public_access_block.nextjs_bucket_public_block
     ]
    bucket = aws_s3_bucket.nextjs_bucket.id
    acl = "public-read"
}
...
resource "aws_cloudfront_distribution" "nextjs_distribution" {
    ...
    default_cache_behavior {
        ...
        target_origin_id = "s3-nextjs-portfoilo-bucket"
